...
<body>
    <form method="post">
        <input type="text" name="str1" placeholder="Enter a sentence" required><br><br>
        <input type="text" name="str2" placeholder="Enter a word" required><br><br>
        <input type="number" name="pos" placeholder="Enter position" required><br><br>
        <input type="number" name="len" placeholder="Enter number of characters" required><br><br>
